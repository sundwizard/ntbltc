<header>
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <h1><a class="navbar-brand" href="{{ route('homepage') }}"><img src="{{ asset('assets/images/logo.png') }}" alt="NTBLTC"/>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button type="button" class="btn hrmls-btn text-uppercase font-weight-bold d-block" data-toggle="modal"
                        aria-pressed="false" data-target="#exampleModal1">
                        Register
                    </button>
                    <button type="button" class="btn hrmls-btn btn-2 ml-lg-1 text-uppercase font-weight-bold d-block"
