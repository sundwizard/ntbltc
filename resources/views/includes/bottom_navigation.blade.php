<footer id="footer" class="py-sm-5 py-4 bg-theme">
        <div class="container">
            ...
            <div class="row  pt-5">
                <div class="col-lg-3 col-sm-6 footer_grid1">
                    <h5><span class="fa fa-map-marker mr-4"></span> Address</h5>
                    <div class="d-flex align-items-center">
                        <span class="fa fa-home mr-4"></span>
                        <p>Natinal Tuberculosis and Leprosy Training Center
                            <br>Saye Zaria.</p>
                    </div>
                    <div class="d-flex mt-3 align-items-center">
                        <span class="fa fa-envelope-open-o mr-4"></span>
                        <p>info@ntbltc.org</p>
                    </div>
                    <div class="d-flex mt-3 align-items-center">
                        <span class="fa fa-phone mr-4"></span>
                        <p>+234802223344</p>
                    </div>                    
                </div>
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-5">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <input type="Submit" class="form-control bg-light-theme  border-0 border-rounded"
    ...
    <div class="cpy-right text-center py-4">
        <p class="text-dark">© 2021 Recruit. All rights reserved.</p>
    </div>